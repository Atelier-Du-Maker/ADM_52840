...
U 1 1 5B9DD21A
P 4675 3200
F 0 "U1" H 4675 4215 50  0000 C CNN
F 1 "HolyIOT_NRF52840" H 4675 4124 50  0000 C CNN
F 2 "LEGACY:HolyIOT-NRF52840-Module" H 4675 3200 50  0001 C CNN
...
U 1 1 5B8D035A
P 3425 1700
F 0 "#PWR0101" H 3425 1450 50  0001 C CNN
F 1 "GND" H 3430 1527 50  0000 C CNN
...
U 1 1 5B8D03CB
P 6025 1750
F 0 "#PWR0102" H 6025 1500 50  0001 C CNN
F 1 "GND" H 6030 1577 50  0000 C CNN
...
U 1 1 5B8D0406
P 6575 3200
F 0 "#PWR0103" H 6575 2950 50  0001 C CNN
F 1 "GND" H 6580 3027 50  0000 C CNN
...
SWDIO
Text GLabel 6075 2600 2    50   Input ~ 0
SWDCLK
Text GLabel 4125 4750 3    50   Input ~ 0
V_NRF
Wire Wire Line
	6275 3200 6575 3200
Wire Wire Line
...
F 1 "10microF" H 3400 4575 50  0000 L CNN
F 2 "LEGACY:SM0805" H 3813 4350 50  0001 C CNN
...
U 1 1 5C001EE9
P 3775 4750
F 0 "#PWR04" H 3775 4500 50  0001 C CNN
...
F 1 "Prog" V 3525 7025 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x06_P2.54mm_Vertical" H 3325 6700 50  0001 C CNN
...
U 1 1 5F9E13C1
P 4825 5150
F 0 "SW3" H 4750 5100 50  0000 L CNN
F 1 "RESET" H 4850 5250 50  0000 L CNN
F 2 "LEGACY:SWITCH_CMS" H 4825 5350 50  0001 C CNN
...
U 1 1 5F9E1660
P 2875 2300
F 0 "SW1" H 2875 2250 50  0000 C CNN
F 1 "BTN1" H 2750 2400 50  0000 C CNN
F 2 "LEGACY:SWITCH_CMS" H 2875 2500 50  0001 C CNN
...
U 1 1 5F9E1D2D
P 5050 7325
F 0 "P1" V 5075 7275 60  0000 L CNN
F 1 "USB_micro_B" V 5225 7025 60  0000 L CNN
...
F 1 "LED1" H 2425 3150 50  0000 C CNN
F 2 "LEGACY:SM0805" H 2525 3300 50  0001 C CNN
...
U 1 1 5F9E3BF7
P 2325 2400
F 0 "SW2" H 2325 2350 50  0000 C CNN
F 1 "BTN2" H 2200 2500 50  0000 C CNN
F 2 "LEGACY:SWITCH_CMS" H 2325 2600 50  0001 C CNN
...
F 1 "MX25R6435F" H 9100 1850 50  0000 L CNN
F 2 "Package_SON:WSON-8-1EP_6x5mm_P1.27mm_EP3.4x4mm" H 9750 875 50  0001 C CNN
F 3 "http://www.macronix.com/Lists/Datasheet/Attachments/7534/MX25R3235F,%20Wide%20Range,%2032Mb,%20v1.6.pdf" H 9750 1475 50  0001 C CNN
	1    9750 1475
	1    0    0    -1  
$EndComp
...
U 1 1 5F9E299B
P 2875 3400
F 0 "D2" H 3000 3350 50  0000 C CNN
F 1 "LED2" H 2825 3250 50  0000 C CNN
F 2 "LEGACY:SM0805" H 2875 3400 50  0001 C CNN
...
U 1 1 5FCA96E3
P 2600 3525
F 0 "#PWR010" H 2600 3275 50  0001 C CNN
F 1 "GND" H 2605 3352 50  0000 C CNN
...
U 1 1 5FCAA1E3
P 1825 2525
F 0 "#PWR06" H 1825 2275 50  0001 C CNN
F 1 "GND" H 1830 2352 50  0000 C CNN
...
U 1 1 5FCAAD11
P 2050 2525
F 0 "#PWR07" H 2050 2275 50  0001 C CNN
F 1 "GND" H 2055 2352 50  0000 C CNN
...
U 1 1 5FD29BB7
P 4825 5425
F 0 "#PWR012" H 4825 5175 50  0001 C CNN
F 1 "GND" H 4830 5252 50  0000 C CNN
...
Wire Wire Line
	5475 3500 5725 3500
Text GLabel 6250 3075 2    50   Input ~ 0
QSPI_2
Wire Wire Line
	4625 3950 4625 4250
Wire Wire Line
...
Wire Wire Line
	4525 4250 4525 4525
Text GLabel 4525 4525 3    50   Input ~ 0
QSPI_3
Wire Wire Line
	4650 4525 4650 4300
Wire Wire Line
...
Wire Wire Line
	4675 4300 4675 3950
Text GLabel 4750 4525 3    50   Input ~ 0
QSPI_CLK
Wire Wire Line
	4725 3950 4725 4400
Wire Wire Line
...
F 1 "JST" H 6525 7275 50  0000 C CNN
F 2 "Connectors_JST:JST_PH_S2B-PH-SM4-TB_02x2.00mm_Angled" H 6525 7175 50  0001 C CNN
...
F 2 "LEGACY:SM0805" V 9030 3675 50  0001 C CNN
...
F 2 "LEGACY:SM0805" H 8725 3675 50  0001 C CNN
...
F 2 "LEGACY:SM0805" V 10230 3475 50  0001 C CNN
...
U 1 1 60422F37
P 1550 3200
F 0 "R2" V 1450 3200 50  0000 C CNN
F 1 "2M" V 1550 3200 50  0000 C CNN
F 2 "LEGACY:SM0805" V 1480 3200 50  0001 C CNN
...
U 1 1 6042357C
P 1825 3175
F 0 "C3" H 1925 3225 50  0000 L CNN
F 1 "1nF" H 1925 3125 50  0000 L CNN
F 2 "LEGACY:SM0603" H 1863 3025 50  0001 C CNN
...
U 1 1 60423B2B
P 1375 3425
F 0 "#PWR09" H 1375 3175 50  0001 C CNN
...
F 1 "806K" V 1550 2800 50  0000 C CNN
F 2 "LEGACY:SM0805" V 1480 2800 50  0001 C CNN
...
Text GLabel 4925 4550 3    50   Input ~ 0
VBUS
Text GLabel 5125 4575 3    50   Input ~ 0
D-
Text GLabel 5025 4550 3    50   Input ~ 0
D+
Wire Wire Line
	4925 4550 4925 4150
Wire Wire Line
...
F 1 "DMP2045U//DMG3415U-7 " H 9025 5150 50  0000 L CNN
F 2 "Package_SON:Diodes_PowerDI3333-8" H 9075 4925 50  0001 L CIN
...
F 2 "LEGACY:SM0805" V 8355 5575 50  0001 C CNN
...
F 2 "LEGACY:SM0805" V 9705 5450 50  0001 C CNN
...
F 1 "SK6812" H 1400 6650 60  0000 C CNN
...
U 1 1 616A1F60
P 1825 7075
F 0 "#PWR03" H 1825 6825 50  0001 C CNN
...
U 1 1 617280D9
P 825 7375
F 0 "J2" V 979 7287 50  0000 R CNN
F 1 "SK6812_OUT" V 875 7325 50  0000 R CNN
F 2 "LEGACY:PADS_CONNEXION" H 825 7375 50  0001 C CNN
...
Wire Wire Line
	825  6975 825  7175
Text GLabel 5775 3825 2    50   Input ~ 0
QSPI_CS
Text GLabel 4650 4525 3    50   Input ~ 0
QSPI_1
$EndSCHEMATC
